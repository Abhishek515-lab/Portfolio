    ...
    <div>
      ...
      <div className="text-left w-250  flex justify-between my-30 ">
        ...
        <h2 className="text-3xl font-bold text-gray-900  "> I'm Abhishek Gupta </h2>
         ...
         <Link to='/Contact'>
       <button className='bg-blue-500 w-30 h-10 rounded-sm text-2xl text-white font-xl cursor-pointer my-3 hover:shadow-blue-600 hover:shadow-sm'>Contact</button>
       </Link>
        </div>
       <div className="co-img"> </div>
      </div>
